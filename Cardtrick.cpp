...
void BuildDeck(int deck[], const int size)
{
	...
	while (i < size)
	{
		...
		if (used[card] == 0)
		{
			...
			//used conter to move to the next deck
			i++;
		}
	}
	return;
...
// pickup function prototype

void PickUp(int deck[], int play[][3], int column)
{
	// using switch statement to test and determine which column first and last  
	int first = 0, last = 0;
